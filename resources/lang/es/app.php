...
return [
    ...
    'messages' => [
        ...
        'loan' => [
            ...
            'validate_loans' => 'El beneficiario :name no ha realizado solicitudes de préstamos.',
        ],
        'users' => [
