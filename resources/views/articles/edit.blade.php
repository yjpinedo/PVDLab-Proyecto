                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 id="formTitle" class="m-portlet__head-text m--font-brand">Editar Artículo</h3>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="m-wizard__form-step m-wizard__form-step--current" id="m_wizard_form_step_1">
                                    <div class="m-form__section m-form__section--first">
                                        ...
                                        <div class="form-group m-form__group col-12">
                                            ...
                                            <input id="brand_form" class="form-control m-input" autocomplete="off" name="brand" type="text" value="{{ $article->brand }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="m-wizard__form-step " id="m_wizard_form_step_2">
                                    <div class="m-form__section m-form__section--first">
                                        <div class="form-group m-form__group col-12">
                                            ...
                                            <input id="serial_form" class="form-control m-input" autocomplete="off" name="serial" type="text" value="{{ $article->serial }}">
                                        </div>
                                        <div class="form-group m-form__group col-12">
                                            <label for="pattern_form">Modelo</label>
                                            <input id="pattern_form" class="form-control m-input" autocomplete="off" name="pattern" type="text" value="{{ $article->pattern }}">
                                        </div>
                                        <div class="form-group m-form__group col-12">
                                            <label for="description_form">Descripción</label>
                                            <textarea id="description_form" class="form-control m-input" rows="5" autocomplete="off" name="description" cols="50" >{{ $article->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
