...
<html>
<head>
    <title>Formato de autorización</title>
...
<style>
    .pa{font-size: 14px;} .cod{ text-align: center; font-size: 13px; } .co{ text-align: center; font-size: 12px; } .cc{margin-left: 190px;} p{text-align: justify;} img{padding-left: 25px;}
</style>
...
<table border="1" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td valign="top">
            <p class="co"><strong>FORMATO DE PROPIEDAD INTELECTUAL Y AUTORIZACIÓN DE USO DE DERECHOS DE IMAGEN SOBRE FOTOGRAFÍAS Y FIJACIONES AUDIOVISUALES (VIDEOS) </strong></p>
        </td>
        <td>
