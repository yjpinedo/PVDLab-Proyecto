            ...
            <div class="m-wizard m-wizard--2 m-wizard--brand m-wizard--step-first" id="m_wizard">
                ...
                <div class="m-wizard__form">
                    <form method="POST" action="#" accept-charset="UTF-8" class="m-form" id="form">
                        @csrf
                        <input id="id_form" name="id" type="hidden" value="{{ $teacher->id }}">
                                ...
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group col-12">
                                        ...
                                        <select id="document_type_form" class="form-control m-bootstrap-select m_selectpicker" name="document_type" tabindex="-98">
                                            ...
                                            <option value="CÉDULA DE CIUDADANÍA" {{ old('document_type') == $teacher->document_type || $teacher->document_type == __('app.selects.person.document_type.CÉDULA DE CIUDADANÍA') ? 'selected' : "" }}>CÉDULA DE CIUDADANÍA</option>
                                            <option value="CÉDULA DE EXTRANJERÍA" {{ old('document_type') == $teacher->document_type || $teacher->document_type == __('app.selects.person.document_type.CÉDULA DE EXTRANJERÍA') ? 'selected' : "" }}>CÉDULA DE EXTRANJERÍA</option>
                                        </select>
                                    </div>
                                    <div class="form-group m-form__group col-12">
                                ...
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group col-12">
                                        ...
                                        <select id="sex_form" class="form-control m-bootstrap-select m_selectpicker" name="sex" tabindex="-98">
                                            <option selected="selected" value="">Seleccione una opción</option>
                                            <option value="FEMENINO" {{ old('sex') == $teacher->sex || $teacher->sex == __('app.selects.person.sex.FEMENINO') ? 'selected' : "" }}>FEMENINO</option>
                                            <option value="MASCULINO" {{ old('sex') == $teacher->sex || $teacher->sex == __('app.selects.person.sex.MASCULINO') ? 'selected' : "" }}>MASCULINO</option>
                                        </select>
                                    </div>
                                    <div class="form-group m-form__group col-12">
                            ...
                            <div class="m-wizard__form-step " id="m_wizard_form_step_3">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group col-12">
                                        ...
                                        <input id="address_form" class="form-control m-input" autocomplete="off" name="address" type="text" value="{{ old('address', $teacher->address) }}">
                                    </div>
                                    <div class="form-group m-form__group col-12">
                                    ...
                                    <div class="form-group m-form__group col-12">
                                        ...
                                        <input id="cellphone_form" class="form-control m-input" autocomplete="off" name="cellphone" type="text" value="{{ old('cellphone', $teacher->cellphone) }}">
                                    </div>
                                    <div class="form-group m-form__group col-12">
                                ...
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group col-12">
                                        ...
                                        <select id="title_type_form" class="form-control m-bootstrap-select m_selectpicker" name="title_type" tabindex="-98">
                                            <option selected="selected" value="">Seleccione una opción</option>
                                            <option value="TÉCNICO" {{ old('title_type') == $teacher->title_type || $teacher->title_type == __('app.selects.teacher.title_type.TÉCNICO') ? 'selected' : "" }}>TÉCNICO</option>
                                            <option value="TECNÓLOGO" {{ old('title_type') == $teacher->title_type || $teacher->title_type == __('app.selects.teacher.title_type.TECNÓLOGO') ? 'selected' : "" }}>TECNÓLOGO</option>
                                            <option value="PROFESIONAL" {{ old('title_type') == $teacher->title_type || $teacher->title_type == __('app.selects.teacher.title_type.PROFESIONAL') ? 'selected' : "" }}>PROFESIONAL</option>
                                            <option value="ESPECIALISTA" {{ old('title_type') == $teacher->title_type || $teacher->title_type == __('app.selects.teacher.title_type.ESPECIALISTA') ? 'selected' : "" }}>ESPECIALISTA</option>
                                            <option value="MAESTRÍA" {{ old('title_type') == $teacher->title_type || $teacher->title_type == __('app.selects.teacher.title_type.MAESTRÍA') ? 'selected' : "" }}>MAESTRÍA</option>
                                            <option value="DOCTORADO" {{ old('title_type') == $teacher->title_type || $teacher->title_type == __('app.selects.teacher.title_type.DOCTORADO') ? 'selected' : "" }}>DOCTORADO</option>
                                        </select>
                                    </div>
                                    <div class="form-group m-form__group col-12">
                                        <label for="collage_form">Institución</label>
                                        <input id="collage_form" class="form-control" autocomplete="off" name="collage" type="text" value="{{ old('collage', $teacher->collage) }}">
                                    </div>
                                    <div class="form-group m-form__group col-12">
                                        <label for="year_form">Año</label>
                                        <input id="year_form" class="form-control m-input" autocomplete="off" name="year" type="text" value="{{ old('year', $teacher->year) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
